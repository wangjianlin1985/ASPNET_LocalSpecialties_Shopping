...
{
    public partial class Front_OrderInfo_List : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("Front_OrderInfo_List.aspx?orderNo=" + orderNo.Text.Trim() + "&&realName=" + realName.Text.Trim()+ "&&telephone=" + telephone.Text.Trim() + "&&orderState=" + orderState.SelectedValue.Trim());
        }
    }
}
