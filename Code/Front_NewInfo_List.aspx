<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Front_NewInfo_List.aspx.cs" Inherits="shuangyulin.Front.Front_NewInfo_List" %>
...
<body>
   <form id="form1" runat="server">
    ...
    <asp:Repeater ID="RpNewInfo" runat="server">
        <HeaderTemplate>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><a href="Front_NewInfo_Details.aspx?newsId=<%#Eval("newsId") %>">查看</a>
             </tr>
        </ItemTemplate>
