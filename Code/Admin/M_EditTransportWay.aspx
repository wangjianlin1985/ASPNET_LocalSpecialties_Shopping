...
<body>
    <form id="form1" runat="server">
        <div class="div_All">
    <div class="Body_Title">运送方式管理 》》编辑运送方式</div>
        <hr />
        <table cellspacing="1" cellpadding="2">
                 <tr>
                   ...
                   运行方式名称：</td>
                    <td width="650px;">
                         <input id="transportName" type="text"   style="width:200px;" runat="server" maxlength="25"/><span class="WarnMes">*</span>请输入运行方式名称！</td>
                </tr>

                <tr>
                    <td></td>
                    <td>
                        <asp:Button ID="BtnTransportWaySave" runat="server" Text=" 保存信息 "
