    ...
    <asp:Repeater ID="RpCosmeticSmallClass" runat="server" onitemcommand="RpCosmeticSmallClass_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><a href="M_EditCosmeticSmallClass.aspx?smallClassId=<%#Eval("smallClassId") %>"><img src="Images/MillMes_ICO.gif" alt="修改信息..." /></a><asp:ImageButton class="DelClass" ID="IBDelClass" runat="server" CommandArgument='<%#Eval("smallClassId")%>' CommandName="Del" ImageUrl="Images/Delete.gif"  ToolTip="删除该信息..."/></td>
             </tr>
        </ItemTemplate>
