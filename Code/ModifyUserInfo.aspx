    ...
    <div class="Body_Title">用户信息管理 》》编辑用户信息</div>
        ...
        <table cellspacing="1" cellpadding="2">
                <tr>
                   ...
                   用户名：</td>
                    <td width="650px;">
                         <input id="username" type="text"   style="width:200px;" runat="server" maxlength="25" readonly/><span class="WarnMes">*</span>请输入用户名！</td>
                </tr>
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Button ID="BtnUserInfoSave" runat="server" Text=" 更新信息 "
